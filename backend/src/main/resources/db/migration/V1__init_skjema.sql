...
(
    ...
    kontaktperson_navn         TEXT NOT NULL,
    kontaktperson_epost        TEXT NOT NULL,
    kontaktperson_telefon      TEXT NOT NULL,
    ansatt_fodselsnummer       TEXT NOT NULL,
    ansatt_navn                TEXT NOT NULL,
    ekspert_navn               TEXT NOT NULL,
    ekspert_virksomhet         TEXT NOT NULL,
    ekspert_kompetanse         TEXT NOT NULL,
    ekspert_problemstilling    TEXT NOT NULL,
    tiltak_for_tilrettelegging TEXT NOT NULL,
    bestilling_kostnad         TEXT NOT NULL,
    bestilling_start_dato      TEXT NOT NULL,
    nav_kontakt                TEXT NOT NULL,
